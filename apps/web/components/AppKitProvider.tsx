...
const metadata = {
  name: "TruthStake",
  description: "Stake on truth. Challenge ambiguity. Let GenLayer consensus decide.",
  url: "https://truthstake.vercel.app",
  icons: ["https://truthstake.vercel.app/favicon.svg"],
};
