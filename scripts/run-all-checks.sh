...
pnpm --filter @truthstake/api exec prisma generate

echo "== 6/6 Typecheck + build (web, api) =="
pnpm --filter @truthstake/web typecheck
pnpm --filter @truthstake/api typecheck
pnpm --filter @truthstake/api build
pnpm --filter @truthstake/web build
