# TRUTHSTAKE — Threat Model

Scope: the deployed system (contract `0x02e8ce1Eb09D689e51c555490BfDC6CAd922C8b3` on GenLayer StudioNet). This is a working threat model reflecting what has actually been built and tested, not a template — every mitigation cited below exists in the codebase today, and every open item is genuinely open, not a formality.
